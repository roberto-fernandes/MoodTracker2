...
public final class Constants {
    public static final List<MoodType> MOOD_TYPES = new ArrayList<MoodType>() {{
        add(new MoodType(40, R.color.faded_red
                , R.drawable.smiley_sad, 0));
        add(new MoodType(55, R.color.warm_grey
                , R.drawable.smiley_disappointed, 1));
        add(new MoodType(70, R.color.cornflower_blue_65
                , R.drawable.smiley_normal, 2));
        add(new MoodType(85, R.color.light_sage
                , R.drawable.smiley_happy, 3));
        add(new MoodType(100, R.color.banana_yellow
                , R.drawable.smiley_super_happy, 4));
    }};
    private static final MoodType DEFAULT_MOOD_TYPE = MOOD_TYPES.get(4);
    public static final MoodType EMPTY_MOOD_TYPE = new MoodType(Integer.MAX_VALUE
            , 100, R.color.background_history_mood);
